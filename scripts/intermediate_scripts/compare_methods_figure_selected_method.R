...
excel_df <- read.table(file=paste0('inputs/',method,'_best_conf_6_6.tsv'),sep='\t',header = TRUE,row.names = NULL)
...
pdf(paste0('figures/',method,'/testbalacc_selectedmethod.pdf'))
...
pdf(paste0('figures/',method,'/trainbalacc_selectedmethod.pdf'))
ggplot(excel_df,aes(x=method))+
  theme_bw() +
...
pdf(paste0('figures/',method,'/testarearejectrate_selectedmethod.pdf'))
ggplot(excel_df,aes(x=method))+
  theme_bw() +
...
pdf(paste0('figures/',method,'/test_area_acc_selectedmethod.pdf'))
ggplot(excel_df,aes(x=method))+
  theme_bw() +
